...
from AppFunctionOperate.WeedInc420.WeedInc420_067 import *
...
class Test_WeedInc420_067(ParameterizedTestCase):
    u'''测试用例WeedInc420的集合'''
    ...
    def test_03_of_DownloadApp(self):
        ...
        # SH_067().game_download(self.c, name="Weed inc 420：Blaze & Trade")
