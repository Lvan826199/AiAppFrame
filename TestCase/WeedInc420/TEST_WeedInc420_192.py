...
from AppFunctionOperate.WeedInc420.WeedInc420_192 import *
...
class Test_WeedInc420_192(ParameterizedTestCase):
    u'''测试用例WeedInc420的集合'''
    ...
    def test_03_of_DownloadApp(self):
        ...
        # SH_192().game_download(self.c, name="Weed inc 420：Blaze & Trade")
