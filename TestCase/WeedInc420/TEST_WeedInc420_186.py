...
from AppFunctionOperate.WeedInc420.WeedInc420_186 import *
...
class Test_WeedInc420_186(ParameterizedTestCase):
    u'''测试用例WeedInc420的集合'''
    ...
    def test_03_of_DownloadApp(self):
        ...
        print("-------------------进行第三个测试用例---------------------")
        # Device(self.device_id).app_uninstall("com.zhgh.cannabis.weed.please.gp")  # 填入自己公司app的ios包名
        ##使用testflight下载对应的app,填入的是在testFlight显示的app全程
        # SH_186().game_download(self.c, name="Weed inc 420：Blaze & Trade")
        print("WeedInc420 下载完毕！")
        print("测试开始")
    ...
    def test_08_of_home(self):
        u'''关闭应用'''
        stop_app("com.zhgh.cannabis.weed.please.gp")