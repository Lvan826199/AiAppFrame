...
from AppFunctionOperate.NorthTower.NorthTower_067 import *
...
class Test_NorthTower_067(ParameterizedTestCase):
    u'''测试用例Demo的集合'''
    ...
    def test_03_of_DownloadApp(self):
        ...
        SH_067().game_download(self.c, name="North Tower! Merge TD Defense")
