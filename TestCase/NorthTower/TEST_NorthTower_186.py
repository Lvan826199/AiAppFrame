...
from AppFunctionOperate.NorthTower.NorthTower_186 import *
...
class Test_NorthTower_186(ParameterizedTestCase):
    u'''测试用例Demo的集合'''
    ...
    def test_03_of_DownloadApp(self):
        ...
        SH_186().game_download(self.c, name="North Tower! Merge TD Defense")
