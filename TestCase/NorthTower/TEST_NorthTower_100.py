...
from AppFunctionOperate.NorthTower.NorthTower_100 import *
...
class Test_NorthTower_100(ParameterizedTestCase):
    u'''测试用例Demo的集合'''
    ...
    def test_03_of_DownloadApp(self):
        ...
        SH_100().game_download(self.c, name="North Tower! Merge TD Defense")
