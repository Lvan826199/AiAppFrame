...
from AppFunctionOperate.LuckyHit.LuckyHit_046 import *
...
class Test_LuckyHit_046(ParameterizedTestCase):
    u'''测试用例Demo的集合'''
    ...
    def test_03_of_DownloadApp(self):
        ...
        SH_046().game_download(self.c, name="Lucky Hit Classic Casino Slots")
