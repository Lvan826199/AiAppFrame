...
from AppFunctionOperate.LuckyHit.LuckyHit_067 import *
...
class Test_LuckyHit_067(ParameterizedTestCase):
    u'''测试用例Demo的集合'''
    ...
    def test_03_of_DownloadApp(self):
        ...
        print("-------------------进行第三个测试用例---------------------")
        Device(self.device_id).app_uninstall("com.bravo.slots.casino.ios")  # 填入自己公司app的ios包名
        ##使用testflight下载对应的app,填入的是在testFlight显示的app全程
        SH_067().game_download(self.c, name="Lucky Hit Classic Casino Slots")
        print("Lucky Hit Classic Casino Slots 下载完毕！")
        print("测试开始")
    ...
    def test_04_of_EnterApp(self):
        u'''检查进入游戏'''
        print("进入游戏部分....")
        packageName = "com.bravo.slots.casino.ios"
        ##启动
    ...
    def test_07_of_otherLevel(self):
        ...
        stop_app("com.bravo.slots.casino.ios")
