...
from AppFunctionOperate.LuckyHit.LuckyHit_186 import *
...
class Test_LuckyHit_186(ParameterizedTestCase):
    u'''测试用例Demo的集合'''
    ...
    def test_03_of_DownloadApp(self):
        ...
        SH_186().game_download(self.c, name="Lucky Hit Classic Casino Slots")
