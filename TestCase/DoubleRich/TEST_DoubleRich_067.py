...
from AppFunctionOperate.DoubleRich.DoubleRich_067 import *
...
def print(*args, **kwargs):
    _print(time.strftime("%Y-%m-%d %H:%M:%S", time.localtime()), "--DoubleRich_067 ", *args, **kwargs)


controlparams = {'control': 1}  # 用作控制器


class Test_DoubleRich_067(ParameterizedTestCase):
    u'''测试用例Demo的集合'''
    ...
    def test_03_of_DownloadApp(self):
        ...
        SH_067().game_download(self.c, name="Double Rich！Vegas Casino Slots")
