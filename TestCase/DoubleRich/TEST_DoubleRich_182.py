...
from AppFunctionOperate.DoubleRich.DoubleRich_182 import *
...
def print(*args, **kwargs):
    _print(time.strftime("%Y-%m-%d %H:%M:%S", time.localtime()), "--DoubleRich_182 ", *args, **kwargs)


controlparams = {'control': 1}  # 用作控制器


class Test_DoubleRich_182(ParameterizedTestCase):
    u'''测试用例Demo的集合'''
    ...
    def test_03_of_DownloadApp(self):
        ...
        SH_182().game_download(self.c, name="Double Rich！Vegas Casino Slots")
