# -*- coding: utf-8 -*-
'''
@Time : 2022/9/23 15:37
@Author : Vincent.xiaozai
@Email : Lvan826199@163.com
@File : TEST_GrandCash_100.py
'''
__author__ = "梦无矶小仔"
...
from AppFunctionOperate.GrandCashSlots.GrandCash_100 import *
...
class Test_GrandCash_100(ParameterizedTestCase):
    u'''测试用例Demo的集合'''
    ...
    def test_03_of_DownloadApp(self):
        ...
        SH_100().game_download(self.c, name="Grand Cash Casino Slots Games")
