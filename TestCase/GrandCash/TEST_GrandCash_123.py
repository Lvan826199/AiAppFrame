...
from AppFunctionOperate.GrandCashSlots.GrandCash_123 import *
...
class Test_GrandCash_123(ParameterizedTestCase):
    ...
    def test_01_of_loginAppStore(self):
        ...
        ###########################
        # appstore 账号登录
        SH_123().loginAppStore(self.c, "xli65512@gmail.com", "Avidly1234")  # 填入用于app store登录的apple id
    ...
    def test_02_of_checkAcount(self):
        ...
        # 沙盒账号登录
        print("-------------------进行第二个测试用例---------------------")
        SH_123().check_acount_ios14(self.c, "xli65512@gmail.com", "Avidly1234")  # 填入用于app充值的沙盒账号
        ###################################

    @unittest.skip
    def test_03_of_AppDownload(self):
        u'''进入TestFlight进行下载App'''
        print("-------------------进行第三个测试用例---------------------")
        ##使用testflight下载对应的app,填入的是在testFlight显示的app全程
        SH_123().game_download(self.c, name="Grand Cash Casino Slots Games")
