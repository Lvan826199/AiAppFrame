...
from AppFunctionOperate.GrandCashSlots.GrandCash_182 import *
...
class Test_GrandCaSH_182(ParameterizedTestCase):
    u'''测试用例Demo的集合'''
    ...
    def test_03_of_Download(self):
        ...
        SH_182().game_download(self.c, name="Grand Cash Casino Slots Games")
