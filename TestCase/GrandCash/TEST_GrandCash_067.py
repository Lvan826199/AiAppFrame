# -*- coding: utf-8 -*-
'''
@Time : 2022/9/21 17:13
@Author : Vincent.xiaozai
@Email : Lvan826199@163.com
@File : TEST_GrandCash_067.py.py
'''
__author__ = "梦无矶小仔"
...
from AppFunctionOperate.GrandCashSlots.GrandCash_067 import *
...
class Test_GrandCash_067(ParameterizedTestCase):
    u'''测试用例Demo的集合'''
    ...
    def test_03_of_DownloadApp(self):
        ...
        SH_067().game_download(self.c, name="Grand Cash Casino Slots Games")
