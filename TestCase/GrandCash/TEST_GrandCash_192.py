...
from AppFunctionOperate.GrandCashSlots.GrandCash_192 import *
...
class Test_GrandCaSH_192(ParameterizedTestCase):
    u'''测试用例Demo的集合'''
    ...
    def test_03_of_DownloadApp(self):
        ...
        try:
            ...
            SH_192().game_download(self.c, name="Grand Cash Casino Slots Games")
            print("Grand Cash Casino Slots Games 下载完毕！")
            print("测试开始")
        except:
            iosScreenshot(self.device_id, "下载App失败")
