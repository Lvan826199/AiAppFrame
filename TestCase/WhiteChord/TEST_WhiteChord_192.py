...
from AppFunctionOperate.WhiteChord.WhiteChord_192 import *
...
class Test_WhiteChord_192(ParameterizedTestCase):
    u'''测试用例WhiteChord的集合'''
    ...
    def test_03_of_DownloadApp(self):
        ...
        # SH_192().game_download(self.c, name="Match Tile Decor")
        print("纯白大作战 下载完毕！")
        print("测试开始")
