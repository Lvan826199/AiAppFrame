...
from AppFunctionOperate.WhiteChord.WhiteChord_049 import *
...
class Test_WhiteChord_049(ParameterizedTestCase):
    u'''测试用例WhiteChord的集合'''
    ...
    def test_03_of_DownloadApp(self):
        ...
        print("-------------------进行第三个测试用例---------------------")
        # Device(self.device_id).app_uninstall("com.zymobile.match.tile.decor.ios")  # 填入自己公司app的ios包名
        ##使用testflight下载对应的app,填入的是在testFlight显示的app全程
        # SH_049().game_download(self.c, name="Match Tile Decor")
        print("纯白大作战 下载完毕！")
        print("测试开始")
