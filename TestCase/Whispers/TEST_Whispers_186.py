...
from AppFunctionOperate.Whispers.Whispers_186 import *
...
class Test_Whisper_186(ParameterizedTestCase):
    ...
    def test_03_of_DownloadApp(self):
        ...
        SH_186().game_download(self.c, name="Whispers - Interactive Stories")
