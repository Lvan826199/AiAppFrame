...
from AppFunctionOperate.Whispers.Whispers_182 import *
...
class Test_Whisper_182(ParameterizedTestCase):
    ...
    def test_03_of_DownloadApp(self):
        ...
        SH_182().game_download(self.c, name="Whispers - Interactive Stories")
