...
from AppFunctionOperate.Whispers.Whispers_123 import *
...
class Test_Whisper_123(ParameterizedTestCase):
    ...
    def test_03_of_DownloadApp(self):
        ...
        SH_123().game_download(self.c, name="Whispers - Interactive Stories")
