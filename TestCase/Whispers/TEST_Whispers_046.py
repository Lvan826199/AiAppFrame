...
from AppFunctionOperate.Whispers.Whispers_046 import *
...
class Test_Whisper_046(ParameterizedTestCase):
    ...
    def test_03_of_DownloadApp(self):
        ...
        SH_046().game_download(self.c, name="Whispers - Interactive Stories")
