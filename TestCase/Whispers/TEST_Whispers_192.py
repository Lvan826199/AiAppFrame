...
from AppFunctionOperate.Whispers.Whispers_192 import *
...
class Test_Whisper_192(ParameterizedTestCase):
    ...
    def test_03_of_DownloadApp(self):
        ...
        SH_192().game_download(self.c, name="Whispers - Interactive Stories")
