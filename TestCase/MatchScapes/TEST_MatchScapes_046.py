...
from AppFunctionOperate.MatchScapes.MatchScapes_046 import *
...
class Test_MatchScapes_046(ParameterizedTestCase):
    u'''测试用例Demo的集合'''
    ...
    def test_01_of_loginAppStore(self):
        ...
        ###########################
        # appstore 账号登录
        SH_046().check_acount(self.c, "wtavidly@gmail.com", "Tll1234567")  # 填入用于app store登录的apple id
    ...
    def test_02_of_checkAcount(self):
        ...
        # SH_046().check_acount_ios14(self.c, "wtavidly@gmail.com", "Tll1234567")  # 填入用于app充值的沙盒账号
        ###################################
    ...
    def test_03_of_DownloadApp(self):
        ...
        # SH_046().game_download(self.c, name="Match Tile Scenery")
