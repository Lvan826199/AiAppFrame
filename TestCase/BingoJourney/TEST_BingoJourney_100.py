...
from AppFunctionOperate.BingoJourney.BingoJourney_100 import *
...
class Test_BingoJourney_0100(ParameterizedTestCase):
    u'''测试用例Demo的集合'''
    ...
    def test_02_of_checkAcount(self):
        ...
        # 沙盒账号登录
        print("-------------------进行第二个测试用例---------------------")
        SH_100().check_acount_ios14(self.c, "jinlimei86@gmail.com", "Avidly1234")
        ###################################
    ...
    def test_03_of_DownloadApp(self):
        ...
        SH_100().game_download(self.c, name="Bingo Journey！Live Bingo Games")
