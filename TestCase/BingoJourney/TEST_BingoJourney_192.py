...
from AppFunctionOperate.BingoJourney.BingoJourney_192 import *
...
class Test_BingoJourney_192(ParameterizedTestCase):
    u'''测试用例Demo的集合'''
    ...
    def test_03_of_DownloadApp(self):
        ...
        SH_192().game_download(self.c, name="Bingo Journey！Live Bingo Games")
