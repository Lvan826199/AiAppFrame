...
class TestDemo_2(ParameterizedTestCase):
    ...
    def test_01_of_loginAppStore(self):
        ...
        # SH_182().loginAppStore(self.c, "jinlimei86@gmail.com", "Zxx12345678")  # 填入用于app store登录的apple id
    ...
    def test_03_of_CheckDownload(self):
        ...
        SH_182().game_download(self.c, name="Whispers - Romance n Choices")
        print("Whispers 下载完毕！")
        print("测试开始")
    ...
    def test_04_of_CheckEnterApp(self):
        ...
        print("-------------------进行第四个测试用例---------------------")
        ##启动
        # self.c = controlTimes['c']
        # self.ios = controlTimes['ios']
