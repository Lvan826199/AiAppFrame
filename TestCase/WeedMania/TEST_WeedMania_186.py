...
from AppFunctionOperate.WeedMania.WeedMania_186 import *
...
class Test_WeedMania_186(ParameterizedTestCase):
    u'''测试用例WeedMania的集合'''
    ...
    def test_08_of_home(self):
        u'''关闭应用'''
        stop_app("com.sfgh.weedmania.ios")