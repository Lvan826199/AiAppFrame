...
from AppFunctionOperate.BingoIsland.BingoIsland_100 import *
...
class Test_BingoIsland_100(ParameterizedTestCase):
    u'''测试用例Demo的集合'''
    ...
    def test_02_of_checkAcount(self):
        ...
        # 沙盒账号登录
        print("-------------------进行第二个测试用例---------------------")
        SH_100().check_acount_ios14(self.c, "xli65512@gmail.com", "Tll1234567")
        ###################################
    ...
    def test_03_of_DownloadApp(self):
        ...
        SH_100().game_download(self.c, name="Bingo Island-Fun Family Bingo")
