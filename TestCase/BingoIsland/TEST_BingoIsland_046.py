...
from AppFunctionOperate.BingoIsland.BingoIsland_046 import *
...
class Test_BingoIsland_046(ParameterizedTestCase):
    u'''测试用例Demo的集合'''
    ...
    def test_01_of_loginAppStore(self):
        ...
        ###########################
        # appstore 账号登录
        SH_046().check_acount(self.c, "xli65512@gmail.com", "Avidly1234")  # 填入用于app store登录的apple id

    @unittest.skip
    def test_02_of_checkAcount(self):
        '''检查AppleID'''
        # 沙盒账号登录
        print("--------------046不需要-----进行第二个测试用例---------------------")
        # SH_046().check_acount_ios14(self.c, "xli65512@gmail.com", "Avidly1234")
        ###################################
    ...
    def test_03_of_DownloadApp(self):
        ...
        SH_046().game_download(self.c, name="Bingo Island-Fun Family Bingo")
