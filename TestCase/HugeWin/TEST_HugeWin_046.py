...
from AppFunctionOperate.HugeWin.HugeWin_046 import *
...
def print(*args, **kwargs):
    _print(time.strftime("%Y-%m-%d %H:%M:%S", time.localtime()), "--HugWin_046 ", *args, **kwargs)


controlparams = {'control': 1}  # 用作控制器


class Test_HugWin_046(ParameterizedTestCase):
    u'''测试用例Demo的集合'''
    ...
    def test_01_of_loginAppStore(self):
        ...
        ###########################
        # appstore 账号登录
        SH_046().check_acount(self.c, "jinlimei86@gmail.com", "Avidly1234")  # 填入用于app store登录的apple id
    ...
    def test_03_of_DownloadApp(self):
        ...
        SH_046().game_download(self.c, name="Huge Win Slots！Casino Games")
