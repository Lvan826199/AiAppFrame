...
from AppFunctionOperate.HugeWin.HugeWin_123 import *
...
def print(*args, **kwargs):
    _print(time.strftime("%Y-%m-%d %H:%M:%S", time.localtime()), "--HugWin_123 ", *args, **kwargs)


controlparams = {'control': 1}  # 用作控制器


class Test_HugWin_123(ParameterizedTestCase):
    u'''测试用例Demo的集合'''
    ...
    def test_03_of_DownloadApp(self):
        ...
        SH_123().game_download(self.c, name="Huge Win Slots！Casino Games")
