...
from AppFunctionOperate.PlagueInvader.PlagueInvader_100 import *
...
def print(*args, **kwargs):
    _print(time.strftime("%Y-%m-%d %H:%M:%S", time.localtime()), "--PlagueInvader_福州卡牌_100 ", *args, **kwargs)


controlparams = {'control': 1}  # 用作控制器


class Test_PlagueInvader_100(ParameterizedTestCase):
    u'''测试用例Demo的集合'''
    ...
    def test_03_of_DownloadApp(self):
        ...
        SH_100().game_download(self.c, name="瘟疫入侵者: 生存之战")
