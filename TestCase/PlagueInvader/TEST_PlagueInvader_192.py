...
from AppFunctionOperate.PlagueInvader.PlagueInvader_192 import *
...
def print(*args, **kwargs):
    _print(time.strftime("%Y-%m-%d %H:%M:%S", time.localtime()), "--PlagueInvader_福州卡牌_192 ", *args, **kwargs)


controlparams = {'control': 1}  # 用作控制器


class Test_PlagueInvader_192(ParameterizedTestCase):
    u'''测试用例Demo的集合'''
    ...
    def test_02_of_checkAcount(self):
        ...
        # 沙盒账号登录
        print("-------------------进行第二个测试用例---------------------")
        # SH_192().check_acount_ios14(self.c,"xli65512@gmail.com", "Tll1234567")  # 填入用于app充值的沙盒账号
        ###################################
    ...
    def test_03_of_DownloadApp(self):
        ...
        SH_192().game_download(self.c, name="瘟疫入侵者: 生存之战")
