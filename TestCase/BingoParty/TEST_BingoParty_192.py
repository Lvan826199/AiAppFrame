...
from AppFunctionOperate.BingoParty.BingoParty_192 import *
...
class Test_BingoParty_192(ParameterizedTestCase):
    u'''测试用例Demo的集合'''
    ...
    def test_01_of_loginAppStore(self):
        ...
        ###########################
        # appstore 账号登录
        SH_192().check_acount(self.c, "treetll94@gmail.com", "Tll654321")  # 填入用于app store登录的apple id

    @unittest.skip
    def test_02_of_checkAcount(self):
        '''检查AppleID'''
        # 沙盒账号登录
        print("-------------------0192不进行第二个测试用例---------------------")
        # SH_192().check_acount_ios14(self.c, "treetll94@gmail.com", "Tll654321")
        ###################################
    ...
    def test_03_of_DownloadApp(self):
        ...
        SH_192().game_download(self.c, name="Bingo Party！Live Classic Bingo")
