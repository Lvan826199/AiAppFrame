...
from AppFunctionOperate.BingoParty.BingoParty_123 import *
...
class Test_BingoParty_123(ParameterizedTestCase):
    u'''测试用例Demo的集合'''
    ...
    def test_01_of_loginAppStore(self):
        ...
        ###########################
        # appstore 账号登录
        SH_123().loginAppStore(self.c, "treetll94@gmail.com", "Tll654321")  # 填入用于app store登录的apple id
    ...
    def test_02_of_checkAcount(self):
        ...
        # 沙盒账号登录
        print("-------------------进行第二个测试用例---------------------")
        SH_123().check_acount_ios14(self.c, "treetll94@gmail.com", "Tll654321")
        ###################################
    ...
    def test_03_of_DownloadApp(self):
        ...
        SH_123().game_download(self.c, name="Bingo Party！Live Classic Bingo")
