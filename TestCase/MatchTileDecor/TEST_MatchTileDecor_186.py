...
from AppFunctionOperate.MatchTileDecor.MatchTileDecor_186 import *
...
gameName = "MatchTileDecor"

class Test_MatchTileDecor_186(ParameterizedTestCase):
    u'''测试用例MatchTileDecor的集合'''
    ...
    def test_03_of_DownloadApp(self):
        ...
        # SH_186().game_download(self.c, name="Match Tile Decor")
        print("MatchTileDecor 下载完毕！")
        print("测试开始")
    ...
    def test_08_of_home(self):
        u'''关闭应用'''
        stop_app("com.zymobile.match.tile.decor.ios")
