...
from AppFunctionOperate.MatchTileDecor.MatchTileDecor_067 import *
...
class Test_MatchTileDecor_067(ParameterizedTestCase):
    ...
    def test_03_of_DownloadApp(self):
        ...
        # SH_067().game_download(self.c, name="Match Tile Decor")
