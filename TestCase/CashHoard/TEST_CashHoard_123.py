...
from AppFunctionOperate.CashHoard.CashHoard_123 import *
...
def print(*args, **kwargs):
    _print(time.strftime("%Y-%m-%d %H:%M:%S", time.localtime()), "--CashHoard_123 ", *args, **kwargs)


controlparams = {'control': 1}  # 用作控制器


class Test_CashHoard_123(ParameterizedTestCase):
    u'''测试用例Demo的集合'''
    ...
    def test_03_of_DownloadApp(self):
        ...
        SH_123().game_download(self.c, name="Cash Hoard Casino Slots Games")
