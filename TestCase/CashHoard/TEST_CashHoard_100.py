...
from AppFunctionOperate.CashHoard.CashHoard_100 import *
...
def print(*args, **kwargs):
    _print(time.strftime("%Y-%m-%d %H:%M:%S", time.localtime()), "--CashHoard_100 ", *args, **kwargs)


controlparams = {'control': 1}  # 用作控制器


class Test_CashHoard_100(ParameterizedTestCase):
    u'''测试用例Demo的集合'''
    ...
    def test_01_of_loginAppStore(self):
        ...
        ###########################
        # appstore 账号登录
        SH_100().loginAppStore(self.c, "jinlimei86@gmail.com", "Avidly1234")  # 填入用于app store登录的apple id
    ...
    def test_02_of_checkAcount(self):
        ...
        # 沙盒账号登录
        print("-------------------进行第二个测试用例---------------------")
        SH_100().check_acount_ios14(self.c, "jinlimei86@gmail.com", "Avidly1234")  # 填入用于app充值的沙盒账号
        ###################################
    ...
    def test_03_of_DownloadApp(self):
        ...
        SH_100().game_download(self.c, name="Cash Hoard Casino Slots Games")
