...
from AppFunctionOperate.CashHoard.CashHoard_192 import *
...
def print(*args, **kwargs):
    _print(time.strftime("%Y-%m-%d %H:%M:%S", time.localtime()), "--CashHoard_192 ", *args, **kwargs)


controlparams = {'control': 1}  # 用作控制器


class Test_CashHoard_192(ParameterizedTestCase):
    u'''测试用例Demo的集合'''
    ...
    def test_01_of_loginAppStore(self):
        ...
        ###########################
        # appstore 账号登录
        SH_192().check_acount(self.c, "jinlimei86@gmail.com", "Avidly1234")  # 填入用于app store登录的apple id
    ...
    def test_03_of_DownloadApp(self):
        ...
        SH_192().game_download(self.c, name="Cash Hoard Casino Slots Games")
