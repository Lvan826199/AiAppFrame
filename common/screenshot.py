...
def iosScreenshot(devices, action):
    ...
    elif devices == 'f4865892438965021723a179972cab72807ce4de':  # SH-SJ-0098
        devices_name = 'SH-SJ-0098'
    elif devices == '00008101-001859DE1E38001E':  # SH-SJ-0123
        devices_name = 'SH-SJ-0123'
    elif devices == 'bba4ba579a9664eba4fc566ca6ef802ca36b71aa':  # SH-SJ-0163
        devices_name = 'SH-SJ-0163'
    elif devices == '00008030-001E19021A42802E':  # #SH-SJ-0186
        devices_name = 'SH-SJ-0186'
    elif devices == '27d62264ebf40fb3a9e4868590b62ff3b4de90ff':  # SH-SJ-0192
        devices_name = 'SH-SJ-0192'
    elif devices == '00008027-001968942140402E':  # SH-SJ-0100
        devices_name = 'SH-SJ-0100'
    elif devices == '49687f67a4c70fbd027e19b4a5e40218acdc06e4':  # SH-SJ-0067
        devices_name = 'SH-SJ-0067'
    else:
