...
from myutils import RunTestCase
from myutils.MultiDevices import MultiDevices
...
def enter_processing(processNo, MD, start):
    ...
    try:
        ...
        #### SH-SJ-049
        elif devices == "e455517036f9aabe3ceb7111a8eaf1c01d7de3f0":
            if not cli_setup():
                auto_setup(__file__, logdir=True,
                           devices=["ios:///http+usbmux://e455517036f9aabe3ceb7111a8eaf1c01d7de3f0", ])
        else:
