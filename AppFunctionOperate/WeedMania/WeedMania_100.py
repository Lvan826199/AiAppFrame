...
def print(*args, **kwargs):
    _print(time.strftime("%Y-%m-%d %H:%M:%S", time.localtime()), "--WeedMania_0100 ", *args, **kwargs)
...
def buy_charge(c, password):
    ...
    while True:
        ...
        # if ocr_exist(img=None, action_text={"+": 0}):
        #     ocr_click(img=None, action_text={"+": 0})
        #     print("成功点击了加号进入付费按钮...准备进行支付....")
