...
def print(*args, **kwargs):
    _print(time.strftime("%Y-%m-%d %H:%M:%S", time.localtime()), "--BingoParty_0186 ", *args, **kwargs)
        ...
        try:
            ...
            if facebook == True:
                if exists(BP_game_home):
                    ...
                    click([1102, 701])  #### 0186 相对[0.578,0.869]  绝对[1102, 701]
                    print("点击[1102, 701]")
                print("FB登录")
                if ios.alert_exists():
                    ios.alert_accept()
                ...
                if exists(BP_game_home):
                    ...
                    click([1431, 709])  # #####0186 相对[0.809,0.857]  绝对[1431, 709]
                print("游客登录")
...
def theme_game(n):
    ...
    while True:
        try:
            ...
            click([746, 468])  ##0186 相对[0.406,0.569] 绝对 [746, 468]
