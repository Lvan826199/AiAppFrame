...
def print(*args, **kwargs):
    _print(time.strftime("%Y-%m-%d %H:%M:%S", time.localtime()), "--福州卡牌_182 ", *args, **kwargs)
...
def OpenGame():
    while True:
        ...
        if exists(facebook_icon_182):
            print("-----存在facebook_icon_182----------进入游戏成功...")
            time.sleep(5)
            break
