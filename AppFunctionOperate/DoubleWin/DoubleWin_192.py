...
def print(*args, **kwargs):
    _print(time.strftime("%Y-%m-%d %H:%M:%S", time.localtime()), "--DoubleWin_0192 ", *args, **kwargs)
...
def alert_click_1():
    play_in_list = [DW_red_quit_1, DW_red_quit_2, DW_red_quit_3, DW_red_quit_4, DW_red_quit_5, DW_ad_close_1, DW_collect_and_play]
    n = 0
    while True:
        try:
            print("-------------弹窗关闭ing------------------")
