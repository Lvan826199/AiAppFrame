...
import logging
from common.WeedInc420Imgs import *
...
def print(*args, **kwargs):
    _print(time.strftime("%Y-%m-%d %H:%M:%S", time.localtime()), "--WeedInc420_0067 ", *args, **kwargs)
...
def permission_click(c):
    ...
    for i in range(10):
        ...
        if ocrScan.ocr_exist(img=None, action_text={"MedMan": 0}):
            print("进入了游戏登录页面！")
            break
